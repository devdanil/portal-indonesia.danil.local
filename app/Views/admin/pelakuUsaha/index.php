...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="<?php echo base_url('admin/tambah-pelaku-usaha') ?>" class="btn btn-primary mb-4">Tambah Pelaku Usaha</a>
                        ...
                        foreach ($pelaku_usaha as $value) { ?>
                          <tr>
                            ...
                            <!-- <td><?php //echo $value->alamat 
                                      ?></td> -->
                            <!-- <td><?php //echo $value->nama_pimpinan 
                                      ?></td> -->
                            ...
                            <td>
                              <?php if ($value->status_registrasi == 1 || $value->status_registrasi == 0) { ?>
                                <a class="btn btn-sm bg-success" href="<?php echo base_url('admin') ?>/approve-pelaku-usaha/<?php echo $value->id_pelaku ?>"
                              ...
                              <?php } ?>
                              <a class="btn btn-sm bg-danger" href="<?php echo base_url('admin') ?>/reject-pelaku-usaha/<?php echo $value->id_pelaku ?>"
                              ...
                              <a class="btn btn-sm bg-primary" href="<?php echo base_url('admin') ?>/detail-pelaku-usaha/<?php echo $value->id_pelaku ?>" data-toggle="tooltip" data-placement="bottom" title="Detail"><i class="fas fa-info-circle"></i></a>
                              <a class="btn btn-sm bg-success" href="<?php echo base_url('admin') ?>/edit-pelaku/<?php echo $value->id_pelaku ?>" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                              <?php if ($value->status_pelaku_usaha == '1') { ?>
                                <a class="btn btn-sm bg-danger" href="<?php echo base_url('admin') ?>/ubah-status-pelaku-usaha/<?php echo $value->id_pelaku ?>/2" data-toggle="tooltip" data-placement="bottom" title="Status Tidak Aktif">
                                  <i class="fas fa-user-times"></i>
                                </a>
                              <?php } else if ($value->status_pelaku_usaha == '2') { ?>
                                <a class="btn btn-sm bg-success" href="<?php echo base_url('admin') ?>/ubah-status-pelaku-usaha/<?php echo $value->id_pelaku ?>/1" data-toggle="tooltip" data-placement="bottom" title="Status Aktif">
                              ...
                              <?php } ?>
                              <a class="btn btn-sm bg-success" href="<?php echo base_url('admin') ?>/pelaku-usaha-admin/reset-password/<?php echo $value->id_pelaku ?>" data-toggle="tooltip" data-placement="bottom" title="Reset Password"><i class="fas fa-unlock-alt"></i></a>
                            </td>
                          </tr>
                        <?php $no++;
                        } ?>
  ...
  <script>
    ...
    $(function() {
      var base_url = "<?= base_url('admin') ?>/tambah-pelaku-usaha";
      $("#example1").DataTable({
        "responsive": true,
        "lengthChange": false,
        "autoWidth": false,
    ...
    function sByEmail() {
      ...
      var url_pelaku = "<?php echo base_url('admin'); ?>/pelaku-usaha-admin";
