...
<head>
  ...
  <title>Portal Indonesia | Panduan</title>
            ...
            <div class="card">
              ...
              <table cellpadding="3" cellspacing="0" border="0" style="width: 67%;">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php $no=1; foreach($panduan as $value) { ?>
                  <tr>
                    <td><?php echo ($value->nama == null ) ? '-' : $value->nama ?></td>
                    <td><?php echo ($value->img_url == null ) ? '-' : $value->img_url ?></td>
                    <td>
                        <?php echo ($value->status == 0 ) ? 'Tidak Aktif' : 'Aktif' ?>
                    </td>
                    <td>
                        <!-- <a class="btn btn-sm bg-danger"  href="<?php echo base_url() ?>/hapus-panduan/<?php echo $value->id ?>" 
                        ...
                        <a class="btn btn-sm bg-primary" href="<?php echo base_url() ?>/edit-panduan/<?php echo $value->id ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class="fas fa-pencil-alt"></i></a> -->
                    </td>
                  </tr>
                  <?php $no++; } ?>
                  </tbody>
