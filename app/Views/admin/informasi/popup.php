          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Popup</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <table cellpadding="3" cellspacing="0" border="0" style="width: 67%;">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <img width="50%" src="<?php echo ($value->img_url == null ) ? '-' : 'assets/uploads/popup/'.$value->img_url ?>">
                    </td>
                    <td><?php echo ($value->link == null ) ? '-' : $value->link ?></td>
                    <td><?php echo ($value->start_date == null ) ? '-' : $value->start_date ?></td>
                    <td><?php echo ($value->end_date == null ) ? '-' : $value->end_date ?></td>
                    <td><?php echo ($value->status == null ) ? '-' : $value->status ?></td>
                    <td>
                        <a class="btn btn-sm bg-danger"  href="<?php echo base_url('admin') ?>/hapus-popup/<?php echo $value->id ?>" 
                        ...
                        <a class="btn btn-sm bg-primary" href="<?php echo base_url('admin') ?>/edit-popup/<?php echo $value->id ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class="fas fa-pencil-alt"></i></a>
                    </td>
                  </tr>
                  <?php } ?>
                  </tbody>
...
<script>
  $(function () {
    var base_url = "<?= base_url('admin') ?>/tambah-popup";
    $("#example1").DataTable({
