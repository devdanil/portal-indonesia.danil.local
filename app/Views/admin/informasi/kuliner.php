              ...
              <table cellpadding="3" cellspacing="0" border="0" style="width: 67%;">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        <a class="btn btn-sm bg-danger"  href="<?php echo base_url() ?>/hapus-kuliner/<?php echo $value->id ?>" 
                        ...
                        <a class="btn btn-sm bg-primary" href="<?php echo base_url() ?>/edit-kuliner/<?php echo $value->id ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class="fas fa-pencil-alt"></i></a>
                    </td>
                  </tr>
                  <?php } ?>
                  </tbody>
...
<script>
  $(function () {
    var base_url = "<?= base_url('') ?>/tambah-kuliner";
    $("#example1").DataTable({
