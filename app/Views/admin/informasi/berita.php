                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-sm bg-<?php echo $warna ?>"  href="<?php echo base_url() ?>/status-berita/<?php echo $value->id ?>" 
                        ...
                        <a class="btn btn-sm bg-success" href="<?php echo base_url() ?>/sent-utama/<?php echo $value->id ?>" 
