        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tata Cara</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Regulasi</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <table cellpadding="3" cellspacing="0" border="0" style="width: 67%;">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php foreach($tatacara as $value) { ?>
                  <tr>
                    <td><?php echo ($value->kategori == null ) ? '-' : $value->kategori ?></td>
                    <td><?php echo ($value->judul == null ) ? '-' : $value->judul ?></td>
                    <td><?php echo ($value->url == null ) ? '-' : $value->url ?></td>
                    <td>
                        <a class="btn btn-sm bg-danger"  href="<?php echo base_url('admin') ?>/hapus-tatacara/<?php echo $value->id_tatacara ?>" 
                        ...
                        <a class="btn btn-sm bg-primary" href="<?php echo base_url('admin') ?>/edit-tatacara/<?php echo $value->id_tatacara ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class="fas fa-pencil-alt"></i></a>
                    </td>
                  </tr>
                  <?php } ?>
                  </tbody>
...
<script>
  $(function () {
    var base_url = "<?= base_url('admin') ?>/tambah-tatacara";
    $("#example1").DataTable({
