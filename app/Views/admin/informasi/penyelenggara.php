...
<head>
  ...
  <title>Portal Indonesia | Penyelenggara</title>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Penyelenggara</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <table cellpadding="3" cellspacing="0" border="0" style="width: 67%;">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php $i=1;foreach($penyelenggara as $value) { ?>
                  <tr>
                    <td><?php echo $i++ ?></td>
                    ...
                    <td><?php echo ($value->kontak == null ) ? '-' : $value->kontak ?></td>
                    <td>
                        <a class="btn btn-sm bg-danger"  href="<?php echo base_url('admin') ?>/hapus-penyelenggara/<?php echo $value->id_penyelenggara ?>" 
                        ...
                        <a class="btn btn-sm bg-primary" href="<?php echo base_url('admin') ?>/edit-penyelenggara/<?php echo $value->id_penyelenggara ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class="fas fa-pencil-alt"></i></a>
                    </td>
                  </tr>
                  <?php } ?>
                  </tbody>
...
<script>
  $(function () {
    var base_url = "<?= base_url('admin') ?>/tambah-penyelenggara";
    $("#example1").DataTable({
