...
<head>
  ...
  <title>Portal Indonesia | <?php echo (empty($model)) ? 'Form Tambah Kategori' : 'Form Edit Kategori' ?></title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo (empty($model)) ? 'Tambah Kategori' : 'Edit Kategori' ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><?php echo (empty($model)) ? 'Form Tambah Kategori' : 'Form Edit Kategori' ?></h3>
              </div>
              ...
              <form method="post" action="<?php echo base_url(); ?><?php echo (empty($model)) ? '/kategori/save' : '/kategori/update/'.$model->id_kategori ?>">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" value="<?php echo (empty($model)) ? '' : $model->kategori ?>" name="kategori" class="form-control" id="kategori" placeholder="Nama Kategori" required>
                  </div>
                  <div class="form-group">
                    <label for="kelompok_usaha">Kelompok Usaha</label>
                    <input type="text" value="<?php echo (empty($model)) ? '' : $model->kelompok_usaha ?>" name="kelompok_usaha" class="form-control" id="kelompok_usaha" placeholder="Industri / non industri" required>
                  </div>
                </div>
                <!-- /.card-body -->
