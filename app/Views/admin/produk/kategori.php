              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        <a class="btn btn-sm bg-danger"  href="<?php echo base_url() ?>/hapus-kategori/<?php echo $value->id_kategori ?>" 
                        ...
                        <a class="btn btn-sm bg-success" href="<?php echo base_url() ?>/edit-kategori/<?php echo $value->id_kategori ?>" 
...
<script>
  $(function () {
    var base_url = "<?= base_url('') ?>/tambah-kategori";
    $("#example1").DataTable({
