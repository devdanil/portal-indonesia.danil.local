          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <?php endif; ?>
              <form enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?><?php echo '/pelaku-usaha-admin/update-password/'.$model->id_pelaku ?>">
                <?= csrf_field(); ?>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="card-footer">
                  ...
                  <a href="<?php echo base_url() ?>/pelaku-usaha-admin" ><button type="button" class="btn btn-success">Kembali</button></a>
                </div>
              </form>
            </div>
            <!-- /.card -->
