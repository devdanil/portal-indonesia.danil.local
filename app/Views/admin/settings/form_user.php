          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <?php endif; ?>
              <form enctype="multipart/form-data" method="post" action="<?php echo base_url('admin'); ?><?php echo (empty($model)) ? '/user/save' : '/user/update/'.$model->id ?>">
                <?= csrf_field(); ?>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
...
$(document).ready(function(e) {
 $('#kategori').change(function(){
     ...
     if (kat_id != ""){
         var post_url = "<?php echo base_url('admin');?>/produk/get_sub_kategori/" + kat_id;
         $.ajax({
             type: "POST",
             url: post_url,
