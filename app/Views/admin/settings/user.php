              ...
              <table cellpadding="3" cellspacing="0" border="0" style="width: 67%;">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        <a class="btn btn-sm bg-danger"  href="<?php echo base_url() ?>/hapus-user/<?php echo $value->id ?>" 
                        ...
                        <a class="btn btn-sm bg-primary" href="<?php echo base_url() ?>/edit-user/<?php echo $value->id ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class="fas fa-pencil-alt"></i></a>
                        <a class="btn btn-sm bg-success" href="<?php echo base_url() ?>/reset-user/<?php echo $value->id ?>" data-toggle="tooltip" data-placement="bottom" title="Reset Password" ><i class="fas fa-unlock-alt"></i></a>
                    </td>
                  </tr>
                  <?php } ?>
                  </tbody>
...
<script>
  $(function () {
    var base_url = "<?= base_url('') ?>/tambah-user";
    $("#example1").DataTable({
