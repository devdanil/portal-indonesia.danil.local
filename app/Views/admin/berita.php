                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-sm bg-<?php echo $warna ?>"  href="<?php echo base_url('admin') ?>/status-berita/<?php echo $value->id ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $text ?>" ><?php echo $text ?></a>
                        ...
                        <a class="btn btn-sm bg-success" href="<?php echo base_url('admin') ?>/sent-utama/<?php echo $value->id ?>" data-toggle="tooltip" data-placement="bottom" title="Utama" >Jadikan Highlight</a>
                        <?php } ?>
                    </td>
                  </tr>
                  <?php } ?>
