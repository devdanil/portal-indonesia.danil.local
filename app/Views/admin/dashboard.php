                      ...
                      <tbody>
                        ...
                        ?>
                          ...
                          <tr>
                            ...
                            <td>
                              <a class="btn btn-sm bg-success" href="<?php echo base_url('admin') ?>/approve-produk/<?php echo $produk_val->id_produk ?>"
                      ...
                      <tbody>
                        ...
                        ?>
                          ...
                          <tr>
                            ...
                            <td><span class="badge badge-danger">Non-Approved</span></td>
                            <td>
                              <a class="btn btn-sm bg-success" href="<?php echo base_url('admin') ?>/approve-pelaku-usaha/<?php echo $pelaku_val->id_pelaku ?>"
                                onclick="return confirm('Apakah anda yakin akan meng-approve produk?')"
                                data-toggle="tooltip" data-placement="bottom" title="Approve"><i class="fas fa-check"></i></a>
                            </td>
                          </tr>
